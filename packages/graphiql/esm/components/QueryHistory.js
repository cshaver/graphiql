...
var shouldSaveQuery = function (query, variables, lastQuerySaved) {
    if (!query) {
        return false;
    }
    try {
...
var QueryHistory = (function (_super) {
    ...
    function QueryHistory(props) {
        ...
        _this.updateHistory = function (query, variables, operationName) {
            if (shouldSaveQuery(query, variables, _this.historyStore.fetchRecent())) {
