...
var GraphiQLSchemaProvider_1 = require("../api/providers/GraphiQLSchemaProvider");
...
var provider_1 = require("./common/themes/provider");
var Tabs_1 = __importDefault(require("./common/Toolbar/Tabs"));
...
exports.GraphiQL = function (props) {
    if (!props.fetcher && !props.uri) {
        throw Error('fetcher or uri property are required');
    }
    var fetcher = common_1.getFetcher(props);
    return (react_1.default.createElement(GraphiQLEditorsProvider_1.EditorsProvider, null,
        react_1.default.createElement(GraphiQLSchemaProvider_1.SchemaProvider, { fetcher: fetcher, config: __assign({ uri: props.uri }, props.schemaConfig) },
            react_1.default.createElement(GraphiQLSessionProvider_1.SessionProvider, { fetcher: fetcher, sessionId: 0 },
                react_1.default.createElement(GraphiQLInternals, __assign({}, __assign({ formatResult: formatResult,
...
var GraphiQLInternals = (function (_super) {
    ...
    GraphiQLInternals.prototype.render = function () {
        var _this = this;
        var Layout = provider_1.useThemeLayout();
        ...
        }) || react_1.default.createElement(GraphiQLLogo, null);
        ...
        var SessionTabs = function (_a) {
            ...
            return (react_1.default.createElement(GraphiQLSessionProvider_1.SessionContext.Consumer, null, function (session) {
                var _a;
                return (react_1.default.createElement(Tabs_1.default, { active: (_a = session === null || session === void 0 ? void 0 : session.currentTabs) === null || _a === void 0 ? void 0 : _a[name], tabs: tabs, onChange: function (tabId) { return session.changeTab(name, tabId); } }, c));
            }));
        };
        var operationEditor = (react_1.default.createElement("section", { "aria-label": "Operation Editor" },
            react_1.default.createElement(SessionTabs, { tabs: ["Operation", "Explorer"], name: "operation" },
                react_1.default.createElement(QueryEditor_1.QueryEditor, { onHintInformationRender: this.handleHintInformationRender, onClickReference: this.handleClickReference, editorTheme: this.props.editorTheme, readOnly: this.props.readOnly, editorOptions: this.props.operationEditorOptions }),
                react_1.default.createElement("div", null, "Explorer"))));
        var variables = (react_1.default.createElement("section", { "aria-label": "Query Variables" },
            react_1.default.createElement(SessionTabs, { tabs: ["Variables", "Console"], name: "variables" },
                react_1.default.createElement(VariableEditor_1.VariableEditor, { onHintInformationRender: this.handleHintInformationRender, onPrettifyQuery: this.handlePrettifyQuery, onMergeQuery: this.handleMergeQuery, editorTheme: this.props.editorTheme, readOnly: this.props.readOnly, editorOptions: this.props.variablesEditorOptions }),
                react_1.default.createElement("div", null, "Console"))));
        var response = (react_1.default.createElement("section", { "aria-label": "Response Editor" },
            react_1.default.createElement(SessionTabs, { tabs: ["Response", "Extensions", "Playground"], name: "results" },
                react_1.default.createElement(react_1.default.Fragment, null,
                    ...
                    react_1.default.createElement(ResultViewer_1.ResultViewer, { editorTheme: this.props.editorTheme, editorOptions: this.props.resultsEditorOptions }),
                    footer),
                react_1.default.createElement("div", null, "Extensions"),
                react_1.default.createElement("div", null, "Playground"))));
        return (react_1.default.createElement(provider_1.Provider, null,
            react_1.default.createElement(Layout, { nav: react_1.default.createElement(react_1.default.Fragment, null,
                    react_1.default.createElement(GraphiQLToolbar, null,
                        logo,
                        react_1.default.createElement(ExecuteButton_1.ExecuteButton, { isRunning: Boolean(this.state.subscription), onStop: this.handleStopQuery }),
                        ...
                        react_1.default.createElement(ToolbarButton_1.ToolbarButton, { onClick: this.handleToggleDocs, title: "Open Documentation Explorer", label: "Docs" }))), session: {
                    ...
                    ? [
                        {
                            key: 'docs',
                            size: 'sidebar',
                            component: (react_1.default.createElement(GraphiQLSchemaProvider_1.SchemaContext.Consumer, null, function (_a) {
                                var schema = _a.schema;
                                return react_1.default.createElement(DocExplorer_1.DocExplorer, { schema: schema });
                            })),
                        },
                    ]
                    ...
                    ? [
                        {
                            key: 'history',
                            size: 'sidebar',
                            component: (react_1.default.createElement(GraphiQLSessionProvider_1.SessionContext.Consumer, null, function (session) {
                                return (react_1.default.createElement(QueryHistory_1.QueryHistory, { onSelectQuery: function (operation, vars, _opName) {
                                        if (operation) {
    ...
    GraphiQLInternals.prototype.autoCompleteLeafs = function () {
        var _a;
        var _b = fillLeafs_1.fillLeafs(this.context.schema, (_a = this.context) === null || _a === void 0 ? void 0 : _a.operation.text, this.props.getDefaultFieldNames), insertions = _b.insertions, result = _b.result;
